...
///         uses.
contract PrecisionRouteL2WethTest is Test {
    ...
    function setUp() public {
        ...
        r = new PrecisionRouteL2(PrecisionPoolFactory(payable(FACTORY)), EXECUTOR, WETH);
    ...
    function _calldata(uint256 amt, uint256 minOut, address to) internal pure returns (bytes memory) {
        ...
        pools[0] = POOL;
        return abi.encodeCall(PrecisionRouteL2.routeFromWETH, (pools, ZORG, amt, minOut, to));
    }
