...
contract zSwapDeployTest is Test {
    ...
    bytes32 constant EXPECTED_HASH = 0xd22b450cb3e9b9d37e2e77220f1f209fdf456d98d47f7b1c1c33cf1f56ef2976;
    uint256 constant EXPECTED_LEN = 311906;
    ...
    function test_HtmlPayloadRoundTrip() public {
        ...
        address[CHUNKS] memory d = [
            z.DATA1(), z.DATA2(), z.DATA3(), z.DATA4(), z.DATA5(), z.DATA6(), z.DATA7(),
            z.DATA8(), z.DATA9(), z.DATA10(), z.DATA11(), z.DATA12(), z.DATA13(), z.DATA14()
        ];
        bytes memory all;
