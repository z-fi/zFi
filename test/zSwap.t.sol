...
contract zSwapDeployTest is Test {
    ...
    bytes32 constant EXPECTED_HASH = 0x0c8281aa01931913e5d27530de25537400ea3d47062731f30bbc0563ed7a08ac;
    uint256 constant EXPECTED_LEN = 675751;
    ...
    function test_HtmlPayloadRoundTrip() public {
        ...
        address[CHUNKS] memory d = [
            ...
            z.DATA20(), z.DATA21(), z.DATA22(), z.DATA23(), z.DATA24(), z.DATA25(), z.DATA26(), z.DATA27(), z.DATA28()
        ];
        bytes memory all;
