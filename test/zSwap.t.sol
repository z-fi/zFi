...
contract zSwapDeployTest is Test {
    ...
    bytes32 constant EXPECTED_HASH = 0xeddad9ea0bbfbe639b44be6c83dcd396448623d9dc0bbd142aa5b94c0e7883f9;
    uint256 constant EXPECTED_LEN = 631321;
    ...
    function test_HtmlPayloadRoundTrip() public {
        ...
        address[CHUNKS] memory d = [
            ...
            z.DATA20(), z.DATA21(), z.DATA22(), z.DATA23(), z.DATA24(), z.DATA25(), z.DATA26()
        ];
        bytes memory all;
