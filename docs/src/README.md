...
- **Why multiple data contracts?** EIP-170 caps deployed code at 24,576 bytes. Splitting the page makes that limit apply per chunk instead of to the full dapp. The current payload is 390,972 bytes across 16 data contracts (24,436 / 24,436 / 24,436 / 24,436 / 24,436 / 24,436 / 24,436 / 24,436 / 24,436 / 24,436 / 24,436 / 24,436 / 24,436 / 24,436 / 24,436 / 24,432 bytes), with 2,244 bytes of 16-chunk headroom.
