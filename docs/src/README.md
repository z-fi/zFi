...
- **Why multiple data contracts?** EIP-170 caps deployed code at 24,576 bytes. Splitting the page makes that limit apply per chunk instead of to the full dapp. The current payload is 321,906 bytes across 14 data contracts (22,994 / 22,994 / 22,994 / 22,994 / 22,994 / 22,994 / 22,994 / 22,994 / 22,994 / 22,994 / 22,994 / 22,994 / 22,994 / 22,984 bytes), with 22,158 bytes of 14-chunk headroom.
