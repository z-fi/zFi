...
contract TokenListRenderer {
    ...
    function tokenURI(uint256, TokenList.Token memory t, Extra[] memory extras) public pure returns (string memory) {
        ...
        string memory svg = string.concat(
            ...
            _chips(t.synced, t.standard, t.frozen, extras),
            _account(t, desc),
    ...
    function _chips(bool synced, TokenList.Standard standard, bool frozen, Extra[] memory extras)
        internal
        pure
        returns (string memory out)
    {
        ...
        string memory provenance = synced
