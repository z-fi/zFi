...
contract Parasol {
    address constant AUGUSTUS = 0x6A000F20005980200259B80c5102003040001068; // Augustus v6
        ...
        payable
    {
        ...
        } else if (allowance(tokenIn, address(this), AUGUSTUS) == 0) {
            safeApprove(tokenIn, AUGUSTUS, type(uint256).max);
        }
