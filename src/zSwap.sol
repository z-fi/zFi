...
/// @dev Architecture: the HTML payload (647318 B) is the runtime bytecode of
///      26 data contracts, deployed separately and passed to the constructor.
...
///      (24576 B per chunk, 16234 B headroom).
///
